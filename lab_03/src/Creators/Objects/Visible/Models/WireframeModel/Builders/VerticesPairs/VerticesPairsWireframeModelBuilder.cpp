...
VerticesPairsBuilder::VerticesPairsBuilder(std::shared_ptr<SourceAdapter> source) {
    this->source = source;
    implementation = std::make_shared<VerticesPairs>();
}

void VerticesPairsBuilder::build_vertices() {
...
void VerticesPairsBuilder::build_edges() {
