...
void Logic::load_object(const std::string& path, const std::string& implementation_type) {
...
void Logic::set_active_object(const std::string& name) {
    if (name == "")
        return;
...
void Logic::move_object(double x_delta, double y_delta, double z_delta) {
...
void Logic::rotate_object(double x_axis_angle, double y_axis_angle, double z_axis_angle) {
...
void Logic::scale_object(double x_coefficient, double y_coefficient, double z_coefficient) {
...
void Logic::move_all_objects(double x_delta, double y_delta, double z_delta) {
...
void Logic::rotate_all_objects(double x_axis_angle, double y_axis_angle, double z_axis_angle) {
...
void Logic::scale_all_objects(double x_coefficient, double y_coefficient, double z_coefficient) {
...
void Logic::set_active_camera(const std::string& name) {
...
void Logic::move_camera(double x_delta, double y_delta, double z_delta) {
...
void Logic::rotate_camera(double x_axis_angle, double y_axis_angle, double z_axis_angle) {
...
std::shared_ptr<Data> Logic::get_data() {
    return data;
}
